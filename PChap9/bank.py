...
class Bank:
    ...
    def __str__(self):
        ...
        lyst =  list(self.accounts)

        self.bubbleSortList(lyst)
        
        message = ""
        for each in lyst:
            print(self.accounts[each])
        return message
...
def main(number = 10, fileName = None):
    ...
    localBank.add(SavingsAccount("Ken", "1001", 1500.00))
    localBank.add(SavingsAccount("Mike", "1002", 3500.00))
    localBank.add(SavingsAccount("Troy", "1003", 5200.00))
    localBank.add(SavingsAccount("Ron", "1004", 5000.00))
    localBank.add(SavingsAccount("Shelby", "1005", 11500.00))
