...
class Directions:
    ...
    def __init__(self,start,end):
        ...
        self.address        = {}
        self.route          = {}
        #create connection to API (using singleton) and Just-in-time instantiation
        self.connection = Connection().getConnection(start,end)
        self.extractData()
    
    def extractData(self):

        root = ET.fromstring(self.connection.content)
